...
// stats calculates and print stats
func stats(email string) {
	commits := processRepositories(email)
	printCommitsStats(commits)
}

// process Repositories given a user email, returns the
...
// cuntDaysSinceDate counts how many days passed since the passed `date`
...
// calcOffset determines and returns teh amount of days missing the fill
// the last row fo the stats graph
func calcOffset() int {
	var offset int
...
// sortMapIntoSlice returns a slice of indexes of map, ordered
...
func printCell(val int, today bool) {
	...
	fmt.Printf(escape+str+"\033[03m", val)
}
